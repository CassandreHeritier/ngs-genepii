            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'ldaps://chu-lyon.fr')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'DC=chu-lyon,DC=fr'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'simonbr'),
                'password' => env('LDAP_PASSWORD', '-TEPed-6cu'),
